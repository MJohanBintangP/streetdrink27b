...
const Menu = () => {
  ...
  return (
    <div id="menu" className="mx-auto flex flex-col mt-[8em] mb-[12rem] max-w-[1400px] px-10 md:px-8">
      <div className="flex gap-2 flex-col mb-[6rem]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <button /*onClick={() => navigate('/Menu')}*/ className="drop-shadow-[4px_5px_1px_rgba(0,0,0,0.25)] cursor-pointer text-[12px] bg-[#FFFF00] px-5 py-2 rounded-[8px] w-full md:w-auto">Lihat Semua</button>
        </div>
      </div>
        ...
        {[
          ...
          <div key={index} className="flex flex-col w-full sm:w-[230px]">
            ...
            <div className="flex flex-row items-center justify-between mt-4 gap-2">
              ...
              <button className="cursor-pointer text-[#FFFF00] text-[12px] border-white border-2 rounded-[8px] py-1 px-6 drop-shadow-[4px_5px_1px_rgba(0,0,0,0.25)]">Beli</button>
            </div>
          </div>
        ))}
      </div>
