...
const Header = () => {
  ...
  return (
    <header id="about" className="relative h-screen bg-[#3D91FF] px-4 sm:px-8 md:px-12 lg:px-16 overflow-hidden">
      {/* Background Images */}
      <img className="absolute right-22 top-30 w-48 sm:w-60 md:w-72 lg:w-80 xl:w-[550px] z-1" src={headerImg} alt="Header" />
      <img className="absolute -right-40 -top-20 w-96 sm:w-[500px] md:w-[550px] lg:w-[600px] xl:w-[650px] max-w-screen overflow-hidden" src={blobs} alt="Blobs" />
      ...
      <div className="mx-auto max-w-7xl text-left sm:text-left">
        <h1 className="relative top-10 sm:top-16 text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white font-bold leading-tight">
          &quot;Seger banget&#39; sehatnya <br className="hidden sm:block" /> dapet&quot;
        </h1>

        <div className="relative top-10 sm:top-50">
          <div className="mb-6 flex flex-col items-center sm:items-start text-center sm:text-left">
            <h2 className="mb-4 text-xl sm:text-2xl md:text-3xl text-[#FFFF00]">Tentang Kami</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 text-white justify-center sm:justify-start">
