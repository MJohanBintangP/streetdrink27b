...
const Menu = () => {
  ...
  return (
    <div
      id="menu"
      className="mx-auto flex flex-col mt-[8em] mb-[15rem] max-w-[1400px] px-10 md:px-8"
    >
      <div className="relative">
        <img
          className="absolute sm:w-8 w-8 sm:-top-15 -top-5 sm:left-86 left-60"
          src={Cookie}
          alt="Cookie"
          loading="lazy"
          decoding="async"
        />
        <img
          className="absolute sm:w-10 w-10 sm:top-8 -top-20 sm:right-40 right-60"
          src={Bread}
          alt="Bread"
          loading="lazy"
          decoding="async"
        />
        <img
          className="absolute sm:w-8 w-8 sm:-bottom-[52rem] -bottom-[150rem] sm:left-66 left-52"
          src={Moon}
          alt="Moon"
          loading="lazy"
          decoding="async"
      ...
      <div className="flex gap-2 flex-col mb-[6rem]">
        ...
        <h3 className="font-semibold text-[#FFFF00] text-[30px]">
          Best Seller
        </h3>
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="max-w-[500px] text-white text-[15px] text-left">
            Ada juga camilan roti panggang klasik yang menarik dan cookies yang
            enak dan pas dinikmati bersama orang terkasih. Menu kami mampu
            menerima pesanan dalam jumlah sedikit dan banyak.
          </p>
          <button
            onClick={() => navigate("/Menu")}
            className="drop-shadow-[4px_5px_1px_rgba(0,0,0,0.25)] cursor-pointer text-[12px] bg-[#FFFF00] px-5 py-2 rounded-[8px] w-full md:w-auto hover:scale-105 transition-transform"
          >
            Lihat Semua
          </button>
        </div>
        ...
        {[
          ...
          <div key={index} className="flex flex-col w-full sm:w-[230px]">
            <img
              ...
              draggable="false"
            />
            <h1 className="text-[#FFFF00] text-[20px] text-left">
              {item.name}
            </h1>
            ...
            <div className="flex flex-row items-center justify-between mt-4 gap-2">
              ...
              >
                <button className="hover:scale-105 transition-transform cursor-pointer text-[#FFFF00] text-[12px] border-white border-2 rounded-[8px] py-1 px-6">
                  Beli
                </button>
              </a>
            </div>
