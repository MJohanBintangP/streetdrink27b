  ...
  return (
    <div className="font-[jua]">
      <nav className="bg-[#3D91FF] w-full h-[80px] fixed top-0 z-90 shadow-md flex items-center px-6 md:px-10">
        <img
          className="absolute top-0 sm:top-0 sm:left-12 left-4 w-30"
          src={cup}
          alt="cup"
          loading="eager"
          fetchPriority="high"
        ...
        <div className="flex justify-between items-center w-full max-w-[1400px] mx-auto">
          <h1 className="text-white relative left-26 text-[18px] md:text-[20px]">
            Menu Kami
          </h1>
          ...
          <button
            onClick={() => navigate("/")}
            className="cursor-pointer text-black flex items-center gap-2 text-[15px] bg-[#FFFF00] px-3 py-2 rounded-lg drop-shadow-[4px_5px_1px_rgba(0,0,0,0.25)] hover:scale-105 transition-transform"
          >
