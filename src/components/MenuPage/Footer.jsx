...
const Footer = () => {
  return (
    <div className="relative">
      <img
        className="absolute -top-[10.9rem] lg:-top-[18.7rem] left-8 lg:left-30 lg:w-[550px] w-[320px] z-10"
        src={people}
        alt="people"
        loading="lazy"
        decoding="async"
      ...
      <footer
        id="footer"
        className="overflow-hidden relative bg-[#3D91FF] lg:mt-[25rem] mt-[18rem] w-full border-t-28 border-[#FFFF00] p-8"
      >
        <div className="flex sm:gap-10 lg:gap-30 gap-10 max-w-[1400px] mx-auto mt-[2rem] mb-[4rem] text-white flex-wrap">
          <div className="flex flex-col gap-5">
            ...
            <a
              ...
              href="https://maps.app.goo.gl/izGYiH6GpdmW5Nup6"
            >
          ...
          <div className="flex flex-col gap-2 font-[inter]">
            ...
            <a
              target="_blank"
              href="https://wa.me/6283176222327?text=Halo%20Streetdrink27b,%20Saya%20ingin%20pesan..."
            >
              +62 831-7622-2327
            </a>
          </div>
        ...
        <img
          className="lg:w-[400px] w-[300px] absolute lg:top-4 lg:right-20 bottom-30 -right-20"
          src={cookie}
          alt="cookie"
          loading="lazy"
          decoding="async"
