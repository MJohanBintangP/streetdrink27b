      ...
      <div className="h-full md:mb-[40rem] mb-[30rem]">
        <section className="relative">
          <div className="relative top-30">
            <div className="flex justify-between items-center mx-auto max-w-[1400px] mb-16 px-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mx-auto max-w-[1440px] px-4">
              {[art1, art2, art3, art4, art5, art6, art7].map((img, index) => (
                <div key={index} className="flex flex-col">
                  <img src={img} className="hover:scale-105 transition-transform drop-shadow-[6px_8px_1px_rgba(0,0,0,0.80)] rounded-3xl w-full h-[250px] object-cover" alt={`Artwork ${index + 1}`} />
                </div>
              ))}
            </div>
          </div>
